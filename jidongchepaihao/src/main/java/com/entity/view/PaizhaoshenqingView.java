...
public class PaizhaoshenqingView extends PaizhaoshenqingEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 申请牌照类型的值
		*/
		private String paizhaoshenqingValue;
		/**
		* 申请状态的值
		*/
		private String paizhaoshenqingYesnoValue;
	...
	public PaizhaoshenqingView() {

	}

	public PaizhaoshenqingView(PaizhaoshenqingEntity paizhaoshenqingEntity) {
		try {
			BeanUtils.copyProperties(this, paizhaoshenqingEntity);
			...
			* 获取： 申请牌照类型的值
			*/
			public String getPaizhaoshenqingValue() {
				return paizhaoshenqingValue;
			}
			/**
			* 设置： 申请牌照类型的值
			*/
			public void setPaizhaoshenqingValue(String paizhaoshenqingValue) {
				this.paizhaoshenqingValue = paizhaoshenqingValue;
			}
			/**
			* 获取： 申请状态的值
			*/
			public String getPaizhaoshenqingYesnoValue() {
				return paizhaoshenqingYesnoValue;
			}
			/**
			* 设置： 申请状态的值
			*/
			public void setPaizhaoshenqingYesnoValue(String paizhaoshenqingYesnoValue) {
				this.paizhaoshenqingYesnoValue = paizhaoshenqingYesnoValue;
			}
